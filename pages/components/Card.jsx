...
import {AddToListChip, QuickViewChip} from '../../components/ActionChip';
import {Rating} from "@mui/material";
import BookmarkIcon from "../../components/BookmarkIcon";

const Card = ({ title, description, image, rating, reviews, platform }) => {
  return (
    <motion.div whileHover={{scale: 1.03}} className="pl-10 pr-5 py-10 rounded-3xl shadow-md container md:w-2/3 flex md:flex-row flex-col mx-auto my-2">
